...
<body>
    <form id="form1" runat="server">
        <div style="margin: 10px; padding-left: 58px;">
            <asp:TextBox ID="txtAccessToken" runat="server" Width="310px"></asp:TextBox>
            &nbsp;
            <asp:Button ID="btnGetAccessToken" runat="server" Text="获取 AccessToken" OnClick="btnGetAccessToken_Click" Width="170px" />
        </div>
        <div>
             &nbsp;FileID：
            <asp:TextBox ID="txtFileID" runat="server" Width="310px">1684795532158432</asp:TextBox>
        </div>
        <div style="margin: 20px;">
            <asp:Panel ID="Panel1ForDWG" runat="server" BorderStyle="Dotted" GroupingText="DWG文件转换">
                ...
                <br />
                <br />
                <asp:Button ID="btnTranslateDwgToVectorDrawings" runat="server" Text="将DWG文件转换成矢量图纸" OnClick="btnTranslateDwgToVectorDrawings_Click" Width="170px" />
                &nbsp;
            <asp:Button ID="btnTranslateDwgToPicture" runat="server" Text="将DWG文件转换成图片" OnClick="btnTranslateDwgToPicture_Click" Width="170px" />
            </asp:Panel>
        </div>
        <div style="margin: 20px;">
            <asp:Panel ID="Panel2ForRvt" runat="server" BorderStyle="Dotted" GroupingText="RVT文件转换">
                ...
                <asp:TextBox ID="txtRvtViewName" runat="server" Width="60px">3D</asp:TextBox>
                &nbsp; 
                <asp:Label ID="Label5" runat="server" Text="设置转换使用的单位：">

                </asp:Label><asp:TextBox ID="txtRvtUnit" runat="server"  Width="60px"></asp:TextBox>
                &nbsp;取值&quot;ft&quot;\&quot;feet&quot;\&quot;英尺&quot;,采用revit默认的英尺为单位, 默认以毫米为单位.<br />
                <br />
                <asp:Button ID="btnTranslateRvtToRenderStyle" runat="server" OnClick="btnTranslateRvtToRenderStyle_Click" Text="将RVT文件转换成着色模式的效果" Width="220px" />
                &nbsp;<asp:Button ID="btnTranslateRvtToRealStyle" runat="server" OnClick="btnTranslateRvtToRealStyle_Click" Text="将RVT文件转换成真实模式的效果" Width="220px" />
                &nbsp;<asp:Button ID="btnTranslateRvtTo23LinkStyle" runat="server" OnClick="btnTranslateRvtTo23LinkStyle_Click" Text="将RVT格式文件转换为具备二三维联动的功能效果" Width="320px" />
                <br />
                <div style="margin-top: 10px;">
                    <asp:Button ID="btnTranslateOther3DModelToWithoutMaterialStyle" runat="server" OnClick="btnTranslateOther3DModelToWithoutMaterialStyle_Click" Text="其它三维模型文件转换，常规转换（不带材质）" Width="320px" />
                    &nbsp;<asp:Button ID="btnTranslateOther3DModelToWithMaterialStyle" runat="server" Text="其他三维模型文件包括RVT格式文件，需要转换出引用的外部材质场景、贴图等" OnClick="btnTranslateOther3DModelToWithMaterialStyle_Click" Width="500px" />
                </div>

            </asp:Panel>
        </div>
        <div style="margin: 10px; padding-left: 30px;">
            <asp:Button ID="btnGetFileTranslateStatus" runat="server" Text="获取转换状态" OnClick="btnGetFileTranslateStatus_Click" Width="170px" />
            &nbsp;<asp:Button ID="btnGetFileTranslateDetails" runat="server" Text="批量获取转换状态详情" OnClick="btnGetFileTranslateDetails_Click" Width="170px" />
            &nbsp;<asp:Button ID="btnGetSingleModelViews" runat="server" OnClick="btnGetSingleModelViews_Click" Text="获取三维视点或二维视图列表" Width="170px" />
            &nbsp;<asp:Button ID="btnGetSingleModelDrawingSheets" runat="server" OnClick="btnGetSingleModelDrawingSheets_Click" Text="获取单个模型的图纸列表" Width="170px" />
        </div>
        <div style="margin: 20px;">
