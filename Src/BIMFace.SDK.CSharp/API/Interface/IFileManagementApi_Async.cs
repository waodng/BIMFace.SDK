// /* ---------------------------------------------------------------------------------------
//    文件名：IFileManagementApi_Async.cs
//    文件功能描述：
// 
//    创建标识：20220412
...
namespace BIMFace.SDK.CSharp.API
{
    public partial interface IFileManagementApi
    {
        ...
        Task<HubsResponse> GetHubsAsync(string accessToken, string dateTimeFrom = "", string dateTimeTo = "",
                                              string info = "", string name = "", string tenantCode = "BIMFACE");
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        Task<HubMetaResponse> GetHubMetaAsync(string accessToken, string hubId);
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        Task<ProjectResponse> CreateProjectAsync(string accessToken, string hubId, string projectName,
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        Task<ProjectsGetResponse> GetProjectsAsync(string accessToken, string hubId, string projectName = "",
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        Task<ProjectResponse> GetProjectInfoAsync(string accessToken, string hubId, string projectId);
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        Task<ProjectResponse> DeleteProjectAsync(string accessToken, string hubId, string projectId);
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        Task<ProjectResponse> UpdateProjectAsync(string accessToken, string hubId, string projectId,
                                                 string projectName = "", string projectInfo = "", string projectThumbnail = "");
        ...
        /// <exception cref="BIMFaceException"></exception>
        Task<FolderResponse> GetFolderAsync(string accessToken, string projectId, string folderId, string folderPath);
        ...
        /// <exception cref="BIMFaceException"></exception>
        Task<FolderContentResponse> GetFolderContentAsync(string accessToken, string projectId, FolderContentRequest request);
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        Task<FolderPathResponse> GetFolderPathAsync(string accessToken, string projectId, string folderId);
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        Task<FolderResponse> GetParentFolderAsync(string accessToken, string projectId, string folderId);
        ...
        /// <returns></returns>
        Task<FolderDeleteResponse> DeleteFolderAsync(string accessToken, string projectId, string folderId, string folderPath);
        ...
        /// <param name="filePath">【必填】 文件所在路径，使用URL编码（UTF-8），最多256个字符（fileItemId和path,必须二选一填入 ）</param>
        /// <returns></returns>
        Task<FileUpload2StatusResponse> GetFileUploadStatusAsync(string accessToken, string projectId, string fileItemId, string filePath);
        ...
        /// <returns></returns>
        Task<FilePath2Response> GetFileDownloadUrlAsync(string accessToken, string projectId, string fileItemId,
                                                        string filePath, string expireTime = null);
        ...
        /// <returns></returns>
        Task<FilePath2Response> GetFilePathAsync(string accessToken, string projectId, string fileItemId);
        ...
        /// <returns></returns>
        Task<FileCopy2Response> CopyFileAsync(string accessToken, string projectId, string targetParentId,
                                              List<string> fileItemPaths, List<string> fileItemIds,
                                              string targetProjectId, string targetParentPath);
        ...
        /// <param name="targetParentPath">【必填】目标位置上层文件夹路径,(targetParentId和targetParentPath必须二选一)</param>
        /// <returns></returns>
        Task<FileMove2Response> MoveFileAsync(string accessToken, string projectId, List<string> fileItemIds,
        ...
        Task<FileDelete2Response> DeleteFilesAsync(string accessToken, string projectId, List<string> fileItemIds);
        ...
        /// <param name="projectId">【必填】 	需要删除的文件Id</param>
        /// <param name="fileItemIds">【必填】文件id,若传多个，使用逗号分隔</param>
        Task<FileDownload2Response> DownloadFilesByZipAsync(string accessToken, string projectId, List<string> fileItemIds);
