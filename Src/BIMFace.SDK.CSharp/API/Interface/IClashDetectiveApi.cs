...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial interface IClashDetectiveApi
    {
        ...
        /// <returns></returns>
        ClashDetectiveResponse StartClashDetective(string accessToken, ClashDetectiveSource selectionA = null,ClashDetectiveSource selectionB = null,
        ...
        /// <returns></returns>
        ClashDetectiveResponse QueryClashDetectiveStatus(string accessToken, string clashDetectiveId);
        ...
        /// <param name="clashDetectiveId">【必填】碰撞检测ID</param>
        /// <returns></returns>
        ClashDetectiveResultResponse QueryClashDetectiveResult(string accessToken, string clashDetectiveId);
        ...
        ClashDetectiveListResponse QueryClashDetectiveList(string accessToken, string fileId, string integrateId);
