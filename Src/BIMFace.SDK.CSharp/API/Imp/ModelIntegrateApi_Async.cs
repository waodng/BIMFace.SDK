...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial class ModelIntegrateApi : IModelIntegrateApi
    {
        ...
        /// <returns></returns>
        public virtual async Task<ModelIntegrateResponse> IntegrateAsync(string accessToken, long fileId1, long fileId2, string callBack = "")
        {
        ...
        /// <param name="callBack">集成时的请求参数</param>
        /// <returns></returns>
        public virtual async Task<ModelIntegrateResponse> IntegrateAsync(string accessToken, Dictionary<long, string> fileIdAndNames, string callBack = "")
        {
        ...
        /// <returns></returns>
        public virtual async Task<ModelIntegrateResponse> IntegrateAsync(string accessToken, FileIntegrateRequest request)
        {
            //PUT https://api.bimface.com/integrate
            string url = BIMFaceConstants.API_HOST + "/integrate";
            string data = await request.SerializeToJsonAsync();
        ...
        /// <returns></returns>
        public virtual async Task<ModelIntegrateResponse> GetIntegrateStatusAsync(string accessToken, long integrateId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<ModelIntegrateQueryResponse> GetIntegrateStatusListAsync(string accessToken, IntegrateQueryRequest request)
        {
        ...
        /// <param name="integrateId">集成模型id</param>
        /// <returns></returns>
        public virtual async Task<ModelIntegrateDeleteResponse> DeleteModelIntegrateAsync(string accessToken, long integrateId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleIntegrateModelElements> GetSingleIntegrateModelElementsAsync(string accessToken, string integrateId, FileElementsGetRequest request = null)
        {
            ...
            try
            {
                ...
                HttpManager httpManager = new HttpManager(headers);
                HttpResult httpResult = await httpManager.GetAsync(url, data);
                if (httpResult.Status == HttpResult.STATUS_SUCCESS)
                {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelSingleElementMaterials> GetSingleModelSingleElementMaterialsAsync(string accessToken, long integrateId, string fileIdHash, string elementId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<ElementsBoundingBoxesCalcResponse> CalcElementsBoundingBoxesAsync(string accessToken, long integrateId, string[] fileIdWithEleIdList)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelSingleElementProperty> GetSingleModelSingleElementPropertyAsync(string accessToken, long integrateId, string elementId, bool? includeOverrides = null)
        {
        ...
        /// <param name="includeOverrides">【非必填】是否查询修改的属性</param>
        /// <returns></returns>
        public virtual async Task<SingleModelSingleElementProperty> GetSingleSubModelSingleElementPropertyAsync(string accessToken, long integrateId, string fileIdHash, string elementId, bool? includeOverrides = null)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelFloors> GetSingleModelFloorsAsync(string accessToken, long integrateId, bool? includeArea = null, bool? includeRoom = null)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleIntegrateModeSubFiles> GetSingleIntegrateModeSubFilesAsync(string accessToken, long integrateId, bool? includeDrawingSheet = null)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelSingleRoom> GetSingleModelSingleRoomAsync(string accessToken, long integrateId, string roomId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelSingleFloorAreas> GetSingleModelSingleFloorAreasAsync(string accessToken, long integrateId, string floorId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelSingleArea> GetSingleModelSingleAreaAsync(string accessToken, long integrateId, string areaId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelTree> GetSingleModelTreeAsync(string accessToken, long integrateId, TreeType treeType = TreeType.Floor, List<List<string>> desiredHierarchy = null, IntegrationTreeOptionalRequestBody request = null)
        {
            /* 单模型构件分类树,
        ...
        /// <returns></returns>
        public virtual async Task<SingleIntegrateModelViews> GetSingleModelViewsAsync(string accessToken, long integrateId, ViewType viewType = ViewType.None)
        {
