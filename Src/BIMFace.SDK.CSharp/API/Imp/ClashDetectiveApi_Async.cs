// /* ---------------------------------------------------------------------------------------
//    文件名：ClashDetectiveApi_Async.cs
//    文件功能描述：
// 
//    创建标识：20220425
...
namespace BIMFace.SDK.CSharp.API
{
    public partial class ClashDetectiveApi : IClashDetectiveApi
    {
        ...
        /// <returns></returns>
        public async virtual Task<ClashDetectiveResponse> StartClashDetectiveAsync(string accessToken, ClashDetectiveSource selectionA = null, ClashDetectiveSource selectionB = null,
        ...
        /// <returns></returns>
        public async virtual Task<ClashDetectiveResponse> QueryClashDetectiveStatusAsync(string accessToken, string clashDetectiveId)
        {
        ...
        /// <param name="clashDetectiveId">【必填】碰撞检测ID</param>
        /// <returns></returns>
        public async virtual Task<ClashDetectiveResultResponse> QueryClashDetectiveResultAsync(string accessToken, string clashDetectiveId)
        {
        ...
        public async virtual Task<ClashDetectiveListResponse> QueryClashDetectiveListAsync(string accessToken, string fileId, string integrateId)
        {
