...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial class ModelElementPropertyOverWriteApi : IModelElementPropertyOverWriteApi
    {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelElementPropertyModifyResponse> ModifySingleModelElementPropertyAsync(string accessToken, long fileId, string elementId, PropertyGroup[] propertyGroups)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelElementPropertyDeleteResponse> DeleteSingleModelElementPropertyAsync(string accessToken, long fileId, string elementId, PropertyGroup[] propertyGroups)
        {
        ...
        /// <param name="propertyGroups">修改的属性</param>
        /// <returns></returns>
        public virtual async Task<IntegrateModelElementPropertyModifyResponse> ModifyIntegrateModelElementPropertyAsync(string accessToken, long integrateId, string fileIdHash, string elementId, PropertyGroup[] propertyGroups)
        {
        ...
        /// <param name="propertyGroups">修改的属性</param>
        /// <returns></returns>
        public virtual async Task<IntegrateModelElementPropertyDeleteResponse> DeleteIntegrateModelElementPropertyAsync(string accessToken, long integrateId, string fileIdHash, string elementId, PropertyGroup[] propertyGroups)
        {
            //PUT https://api.bimface.com/data/v2/integrations/{integrateId}/files/{fileIdHash}/elements/{elementId}/properties
