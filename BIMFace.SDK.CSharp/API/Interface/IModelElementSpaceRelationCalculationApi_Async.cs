...
{   /// <summary>
    ...
    public partial interface IModelElementSpaceRelationCalculationApi
    {
        ...
        /// <returns></returns>
        Task<QueryFloorRoomsResponse> QueryFloorRoomsByFileIdAsync(string accessToken, long fileId, string elementId = null, string floorId = null,
        ...
        /// <param name="roomToleranceZ">Z方向的误差容许程度</param>
        /// <returns></returns>
        Task<QueryFloorRoomsResponse> QueryFloorRoomsByIntegrateIdAsync(string accessToken, long integrateId, string elementId = null, string fileIdHash = null, string floorId = null,
                                                             RoomTolerance roomToleranceXY = RoomTolerance.ORDINARY, RoomTolerance roomToleranceZ = RoomTolerance.STRICT);
    }
}