...
{  /// <summary>
   ...
   /// </summary>
    public partial interface IModelInfoAndElementPropertyQueryApi
    {
        ...
        /// <returns></returns>
        Task<QueryElementIdsResponse> QueryElementIdsAsync(string accessToken, string dsl, bool includeOverrid = false);
        ...
        /// <param name="includeOverrid">是否查询修改的属性</param>
        /// <returns></returns>
        Task<QueryPropertyValuesResponse> QueryPropertyValuesAsync(string accessToken, string[] properties, string[] targetIds, string targetType = "file", bool includeOverrid = false);
        ...
        /// <param name="accessToken">【必填】令牌</param>
        /// <returns></returns>
        Task<QueryPaginationContextIdResponse> QueryPaginationContextIdAsync(string accessToken);
    }
}