...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial class FileManagementApi : IFileManagementApi
    {
        ...
        public virtual async Task<HubsResponse> GetHubsAsync(string accessToken, string dateTimeFrom = "", string dateTimeTo = "", string info = "", string name = "", string tenantCode = "BIMFACE")
        {
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<HubMetaResponse> GetHubMetaAsync(string accessToken, string hubId)
        {
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<ProjectResponse> CreateProjectAsync(string accessToken, string hubId, string projectName, string projectInfo = null, string projectThumbnail = null)
        {
            ...
            string data = await new ProjectSaveRequest
            {
                Name = projectName,
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<ProjectsGetResponse> GetProjectsAsync(string accessToken, string hubId, string projectName = "", bool useFuzzySearch = false)
        { 
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<ProjectResponse> GetProjectInfoAsync(string accessToken, string hubId, string projectId)
        {
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<ProjectResponse> UpdateProjectAsync(string accessToken, string hubId, string projectId, string projectName = null, string projectInfo = null, string projectThumbnail = null)
        {
            ...
            try
            {
                ...
                HttpManager httpManager = new HttpManager(headers);
                HttpResult httpResult = await httpManager.PatchAsync(url, data);
                if (httpResult.Status == HttpResult.STATUS_SUCCESS)
                {
                    response = httpResult.Text.DeserializeJsonToObject<ProjectResponse>();
                }
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<ProjectResponse> DeleteProjectAsync(string accessToken, string hubId, string projectId)
        {
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<FolderResponse> CreateFolderAsync(string accessToken, string projectId, string folderName, string parentPath, string parentId, bool? autoRename = null)
        {
            ...
            string data = await new FolderCreateRequest
            {
                Name = folderName,
        ...
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<FolderResponse> GetFolderAsync(string accessToken, string projectId, string folderId, string folderPath)
        {
        ...
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<FolderContentResponse> GetFolderContentAsync(string accessToken, string projectId, FolderContentRequest request)
        {
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<FolderPathResponse> GetFolderPathAsync(string accessToken, string projectId, string folderId)
        { 
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<FolderResponse> GetParentFolderAsync(string accessToken, string projectId, string folderId)
        {
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<FolderResponse> UpdateFolderAsync(string accessToken, string projectId, string folderName, string folderId, string folderPath, bool? autoRename = null)
        {
            ...
            string url = string.Format(BIMFaceConstants.API_HOST + "/bdfs/data/v1/projects/{0}/folders", projectId);
            string data = await new FolderUpdateRequest
            {
                Name = folderName,
                Path = folderPath,
                FolderId = folderId,
        ...
        /// <returns></returns>
        public virtual async Task<FolderDeleteResponse> DeleteFolderAsync(string accessToken, string projectId, string folderId, string folderPath)
        {
        ...
        /// <returns></returns>
        public virtual async Task<FileUpload2Response> UploadFileByStreamAsync(string accessToken, string projectId, string fileName, Stream fileStream, string parentId, string parentPath, bool? autoRename = null, string sourceId = "")
        {
            ...
            try
            {
                ...
                HttpManager httpManager = new HttpManager(headers);
                HttpResult httpResult = await httpManager.UploadDataAsync(url, fileBytes, WebRequestMethods.Http.Post);
                if (httpResult.Status == HttpResult.STATUS_SUCCESS)
                {
        ...
        /// <returns></returns>
        public virtual async Task<FileUpload2Response> UploadFileByUrlAsync(string accessToken, string projectId, string fileName, string parentId, string parentPath, string fileUrl, bool? autoRename = null, string sourceId = "", string etag = "", long? maxLength = null)
        {
        ...
        /// <param name="maxLength">【可选】</param>
        /// <returns></returns>
        internal virtual async Task<FileUploadPolicyResponse> GetFileUploadPolicyAsync(string accessToken, string projectId, string fileName, string parentId, string parentPath, bool? autoRename = null, string sourceId = "", long? maxLength = null)
        {
        ...
        /// <param name="maxLength">【可选】</param>
        /// <returns></returns>
        public virtual async Task<FileUpload2Response> UploadFileByPolicyAsync(string accessToken, string projectId, string fileFullName, string parentId, string parentPath, bool? autoRename = null, string sourceId = "", long? maxLength = null)
        {
            ...
            */
            ...
            try
            {
                ...
                FileUploadPolicyResponse policyResponse = await GetFileUploadPolicyAsync(accessToken, projectId, fileName, parentId, parentPath, autoRename, sourceId, maxLength);
                if (policyResponse.Code == HttpResult.STATUS_SUCCESS)
                {
                    ...
                    */
                    ...
                    HttpManager httpManager = new HttpManager(headers);
                    HttpResult httpResult = await httpManager.UploadFormByMultipartAsync(url, fileFullName, kVDatas);
                    if (httpResult.Status == HttpResult.STATUS_SUCCESS)
                    {
                        response = httpResult.Text.DeserializeJsonToObject<FileUpload2Response>();
                    }
        ...
        /// <returns></returns>
        public virtual async Task<FileItemResponse> GetFileAsync(string accessToken, string projectId, string fileItemId, string filePath, bool? withItemSource = null)
        {
        ...
        /// <param name="filePath">【必填】 文件所在路径，使用URL编码（UTF-8），最多256个字符（fileItemId和path,必须二选一填入 ）</param>
        /// <returns></returns>
        public virtual async Task<FileUpload2StatusResponse> GetFileUploadStatusAsync(string accessToken, string projectId, string fileItemId, string filePath)
        {
        ...
        /// <returns></returns>
        public virtual async Task<FilePath2Response> GetFileDownloadUrlAsync(string accessToken, string projectId, string fileItemId, string filePath, string expireTime = null)
        {
        ...
        /// <returns></returns>
        public virtual async Task<FilePath2Response> GetFilePathAsync(string accessToken, string projectId, string fileItemId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<FileCopy2Response> CopyFileAsync(string accessToken, string projectId, string targetParentId, List<string> fileItemPaths, List<string> fileItemIds, string targetProjectId, string targetParentPath)
        {
            /* 官方文档：https://bimface.com/docs/file-management/v1/api-reference/copyFileUsingPOST.html */
            ...
            string data = await new FileCopy2Request()
            {
        ...
        /// <param name="targetParentPath">【必填】目标位置上层文件夹路径,(targetParentId和targetParentPath必须二选一)</param>
        /// <returns></returns>
        public virtual async Task<FileMove2Response> MoveFileAsync(string accessToken, string projectId, List<string> fileItemIds, List<string> fileItemPaths, string targetParentId, string targetParentPath)
        {
            ...
            string data = await new FileMove2Request()
            {
                FileItemIds = fileItemIds,
                FileItemPaths = fileItemPaths,
                TargetParentId = targetParentId,
        ...
        /// <returns></returns>
        public virtual async Task<FileItemResponse> RenameFileAsync(string accessToken, string projectId, string fileItemId, string filePath, string newFileName, bool? autoRename = null)
        {
            ...
            try
            {
                ...
                HttpManager httpManager = new HttpManager(headers);
                HttpResult httpResult = await httpManager.PatchAsync(url);
                if (httpResult.Status == HttpResult.STATUS_SUCCESS)
                {
                    response = httpResult.Text.DeserializeJsonToObject<FileItemResponse>();
                }
        ...
        public virtual async Task<FileDelete2Response> DeleteFilesAsync(string accessToken, string projectId, List<string> fileItemIds)
        {
            ...
            string url = string.Format(BIMFaceConstants.API_HOST + "/bdfs/data/v1/projects/{0}/fileItems", projectId);
            string data = await fileItemIds.SerializeToJsonAsync();
            ...
            try
            {
                ...
                HttpManager httpManager = new HttpManager(headers);
                HttpResult httpResult = await httpManager.DeleteAsync(url, data);
                if (httpResult.Status == HttpResult.STATUS_SUCCESS)
                {
        ...
        /// <param name="projectId">【必填】 	需要删除的文件Id</param>
        /// <param name="fileItemIds">【必填】文件id,若传多个，使用逗号分隔</param>
        public virtual async Task<FileDownload2Response> DownloadFilesByZipAsync(string accessToken, string projectId, List<string> fileItemIds)
        {
