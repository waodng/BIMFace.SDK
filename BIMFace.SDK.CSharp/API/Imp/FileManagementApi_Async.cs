...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial class FileManagementApi : IFileManagementApi
    {
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<ProjectResponse> CreateProjectAsync(string accessToken, string hubId, string projectName, string projectInfo = "", string projectThumbnail = "")
        {
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<ProjectResponse> UpdateProjectAsync(string accessToken, string hubId, string projectId, string projectName = "", string projectInfo = "", string projectThumbnail = "")
        {
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<FolderResponse> CreateFolderAsync(string accessToken, string projectId, string folderName, string parentPath, string parentId, bool autoRename = false)
        {
        ...
        /// <returns></returns>
        /// <exception cref="BIMFaceException"></exception>
        public virtual async Task<FolderResponse> UpdateFolderAsync(string accessToken, string projectId, string folderName, string folderId, string folderPath, bool autoRename = false)
        {
        ...
        /// <returns></returns>
        public virtual async Task<FileUpload2Response> UploadFileByStreamAsync(string accessToken, string projectId, string fileName, Stream fileStream, string parentId, string parentPath, bool autoRename = false, string sourceId = "")
        {
            ...
            try
            {
                ...
                HttpManager httpManager = new HttpManager(headers);
                HttpResult httpResult = await httpManager.UploadDataAsync(url, fileBytes, WebRequestMethods.Http.Put);
                if (httpResult.Status == HttpResult.STATUS_SUCCESS)
                {
        ...
        /// <returns></returns>
        public virtual async Task<FileUpload2Response> UploadFileByUrlAsync(string accessToken, string projectId, string fileName, string parentId, string parentPath, string fileUrl, bool autoRename = false, string sourceId = "", string etag = "", long? maxLength = null)
        {
        ...
        /// <param name="maxLength">【可选】</param>
        /// <returns></returns>
        internal virtual async Task<FileUploadPolicyResponse> GetFileUploadPolicyAsync(string accessToken, string projectId, string fileName, string parentId, string parentPath, bool autoRename = false, string sourceId = "", long? maxLength = null)
        {
        ...
        /// <param name="maxLength">【可选】</param>
        /// <returns></returns>
        public virtual async Task<FileUpload2Response> UploadFileByPolicyAsync(string accessToken, string projectId, string fileFullName, string parentId, string parentPath, bool autoRename = false, string sourceId = "", long? maxLength = null)
        {
        ...
        /// <returns></returns>
        public virtual async Task<FileItemResponse> GetFileAsync(string accessToken, string projectId, string fileItemId, string filePath, bool withItemSource = false)
        {
        ...
        /// <param name="withItemSource">【选填】</param>
        /// <returns></returns>
        public virtual async Task<FileItemResponse> RenameFileAsync(string accessToken, string projectId, string fileItemId, string filePath, string newFileName, bool withItemSource = false)
        {
