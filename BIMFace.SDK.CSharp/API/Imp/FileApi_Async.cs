...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial class FileApi : IFileApi
    {
        ...
        /// <returns></returns>
        public virtual async Task<FileUploadResponse> UploadFileByStreamAsync(string accessToken, string fileName, Stream fileStream, string sourceId = "")
        {
        ...
        /// <returns></returns>
        public virtual async Task<FileUploadResponse> UploadFileByUrlAsync(string accessToken, string fileName, string fileUrl, string sourceId = "", string etag = "")
        {
            // 此API详解，参考作者博客：《C#开发BIMFACE系列4 服务端API之源上传文件》 https://www.cnblogs.com/SavionZhang/p/11425804.html
        ...
        /// <param name="sourceId">【可选】调用方的文件源ID，不能重复</param>
        /// <returns></returns>
        public virtual async Task<FileUploadPolicyResponse> GetFileUploadPolicyAsync(string accessToken, string fileName, string sourceId = "")
        {
        ...
        /// <returns></returns>
        public virtual async Task<FileUploadResponse> UploadFileByPolicyAsync(string accessToken, string fileFullName)
        {
            // 此API详解，参考作者博客：《C#开发BIMFACE系列5 服务端API之文件直传》 https://www.cnblogs.com/SavionZhang/p/11425945.html
        ...
        /// <returns></returns>
        public virtual async Task<FileInfoGetResponse> GetFileInfoAsync(string accessToken, long fileId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<FileInfoListGetResponse> GetFileInfoListAsync(string accessToken, string startTime = "", string endTime = "", long rows = 100, long offset = -1, string status = "", string suffix = "")
        {
        ...
        /// <param name="fileId">文件ID</param>
        /// <returns></returns>
        public virtual async Task<FileUploadStatusResponse> GetFileUploadStatusAsync(string accessToken, long fileId)
        {
        ...
        /// </summary>
        /// <param name="accessToken">【必填】令牌</param>
        public virtual async Task<FileSupportResponse> GetFileSupportAsync(string accessToken)
        {
        ...
        /// <returns></returns>
        public virtual async Task<FileDownloadUrlGetResponse> GetFileDownloadUrlAsync(string accessToken, long fileId, string name = "")
        {
        ...
        /// <param name="fileId">文件ID</param>
        /// <returns></returns>
        public virtual async Task<FileDeleteResponse> DeleteFileAsync(string accessToken, long fileId)
        {
