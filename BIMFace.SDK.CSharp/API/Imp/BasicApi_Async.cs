...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial class BasicApi : IBasicApi
    {
        ...
        /// <returns></returns>
        public async Task<AccessTokenResponse> GetAccessTokenAsync(string appKey, string appSecret)
        {
        ...
        /// <returns></returns>
        protected async Task<ViewTokenResponse> GetViewTokenAsync(string accessToken, ModelType modelType, long objectId)
        {
        ...
        /// <returns></returns>
        public async Task<ViewTokenResponse> GetViewTokenByFileIdAsync(string accessToken, long fileId)
        {
            return await GetViewTokenAsync(accessToken, ModelType.fileId, fileId);
        }
        ...
        /// <returns></returns>
        public async Task<ViewTokenResponse> GetViewTokenByIntegrateIdAsync(string accessToken, long integrateId)
        {
            return await GetViewTokenAsync(accessToken, ModelType.integrateId, integrateId);
        }
        ...
        /// <returns></returns>
        public async Task<ViewTokenResponse> GetSubFileViewTokenAsync(string accessToken, long integrateId, long fileId)
        {
        ...
        public async Task<ConcurrentDictionary<long, ViewTokenResponse>> GetViewTokenListAsync(string accessToken, ModelType modelType, List<long> objectIds)
        {
            ...
            foreach (var fileId in objectIds)
            {
                try
                {
                    var response = await GetViewTokenAsync(accessToken, modelType, fileId);
