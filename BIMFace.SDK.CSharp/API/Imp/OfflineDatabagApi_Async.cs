...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial class OfflineDatabagApi : IOfflineDatabagApi
    {
        ...
        /// </param>
        /// <returns></returns>
        public virtual async Task<DatabagDerivativeCreateResponse> CreateDatabagByIntegrateIdAsync(string accessToken, long integrateId, string callback = null, DatabagDerivativeRequest request = null)
        {
            return await CreateDatabagAsync(accessToken, integrateId, ModelType.integrateId, callback, request);
        }
        ...
        /// </param>
        /// <returns></returns>
        public virtual async Task<DatabagDerivativeCreateResponse> CreateDatabagByCompareIdAsync(string accessToken, long compareId, string callback = null, DatabagDerivativeRequest request = null)
        {
        ...
        /// <param name="compareId">【必填】模型对比Id</param>
        /// <returns></returns>
        public virtual async Task<DatabagDerivativeQueryResponse> QueryDatabagByCompareIdAsync(string accessToken, long compareId)
        {
            return await QueryDatabagAsync(accessToken, compareId, ModelType.compareId);
        }
