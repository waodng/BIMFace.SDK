...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial class RfaFileApi : IRfaFileApi
    {
        ...
        public virtual async Task<RfaFileFamilyTypePropertyKeyListResponse> GetRfaFileFamilyTypePropertyKeyListAsync(string accessToken, long rfaFileId)
        {
        ...
        public virtual async Task<RfaFileFamilyTypePropertyListResponse> GetRfaFileFamilyTypePropertyListAsync(string accessToken, long rfaFileId, string familyTypeGuid)
        {
        ...
        /// <param name="accessToken">【必填】令牌</param>
        /// <param name="rfaFileId">【必填】rfaFileId</param>
        public virtual async Task<RfaFileFamilyTypeListResponse> GetRfaFileFamilyTypeListAsync(string accessToken, long rfaFileId)
        {
