...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial class ModelInfoAndElementPropertyQueryApi : IModelInfoAndElementPropertyQueryApi
    {
        ...
        /// <returns></returns>
        public virtual async Task<QueryElementIdsResponse> QueryElementIdsAsync(string accessToken, string dsl, bool includeOverrid = false)
        {
            ...
            try
            {
                ...
                HttpResult httpResult = await httpManager.PostAsync(url, dsl);
        ...
        /// <param name="includeOverrid">是否查询修改的属性</param>
        /// <returns></returns>
        public virtual async Task<QueryPropertyValuesResponse> QueryPropertyValuesAsync(string accessToken, string[] properties, string[] targetIds, string targetType = "file", bool includeOverrid = false)
        {
        ...
        /// <param name="accessToken">【必填】令牌</param>
        /// <returns></returns>
        public virtual async Task<QueryPaginationContextIdResponse> QueryPaginationContextIdAsync(string accessToken)
        {
