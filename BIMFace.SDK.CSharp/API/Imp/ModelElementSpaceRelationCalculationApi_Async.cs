...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial class ModelElementSpaceRelationCalculationApi : IModelElementSpaceRelationCalculationApi
    {
        ...
        /// <returns></returns>
        public virtual async Task<QueryFloorRoomsResponse> QueryFloorRoomsByFileIdAsync(string accessToken, long fileId, string elementId = null, string floorId = null, RoomTolerance roomToleranceXY = RoomTolerance.ORDINARY, RoomTolerance roomToleranceZ = RoomTolerance.STRICT)
        {
        ...
        /// <param name="roomToleranceZ">Z方向的误差容许程度</param>
        /// <returns></returns>
        public virtual async Task<QueryFloorRoomsResponse> QueryFloorRoomsByIntegrateIdAsync(string accessToken, long integrateId, string elementId = null, string fileIdHash = null, string floorId = null, RoomTolerance roomToleranceXY = RoomTolerance.ORDINARY, RoomTolerance roomToleranceZ = RoomTolerance.STRICT)
        {
