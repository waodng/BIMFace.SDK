...
namespace BIMFace.SDK.CSharp.API
{
    ...
    ///  分享链接API实现
    /// </summary>
    public partial class ShareLinkApi : IShareLinkApi
    {
        /// <summary>
        ...
        /// <returns></returns>
        public virtual async Task<ShareLinkResponse> CreateShareLinkByFileIdAsync(string accessToken, long fileId, int? activeHours = null, string expireDate = null, bool? needPassword = null)
        {
            return await CreateShareLinkAsync(accessToken, fileId, ModelType.fileId, activeHours, expireDate, needPassword);
        }
        ...
        /// <param name="needPassword">分享链接是否生成访问密码</param>
        /// <returns></returns>
        public virtual async Task<ShareLinkResponse> CreateShareLinkByIntegrateIdAsync(string accessToken, long integrateId, int? activeHours = null, string expireDate = null, bool? needPassword = null)
        {
            return await CreateShareLinkAsync(accessToken, integrateId, ModelType.integrateId, activeHours, expireDate, needPassword);
        }
        ...
        /// <param name="needPassword">分享链接是否生成访问密码</param>
        /// <returns></returns>
        private async Task<ShareLinkResponse> CreateShareLinkAsync(string accessToken, long objectId, ModelType modelType, int? activeHours = null, string expireDate = null, bool? needPassword = null)
        {
        ...
        /// <returns></returns>
        public virtual async Task<ShareLinkResponse> GetShareLinkByFileIdAsync(string accessToken, long fileId)
        {
            return await GetShareLinkAsync(accessToken, fileId, ModelType.fileId);
        }
        ...
        /// <returns></returns>
        public virtual async Task<ShareLinkResponse> GetShareLinkByIntegrateIdAsync(string accessToken, long integrateId)
        {
            return await GetShareLinkAsync(accessToken, integrateId, ModelType.integrateId);
        }
        ...
        /// <returns></returns>
        public virtual async Task<ShareLinkResponse> GetShareLinkByTokenAsync(string accessToken, string token)
        {
            return await GetShareLinkAsync(accessToken, token, ModelType.token);
        }
        ...
        /// <returns></returns>
        private async Task<ShareLinkResponse> GetShareLinkAsync(string accessToken, object objectId, ModelType modelType)
        {
        ...
        /// <returns></returns>
        public virtual async Task<ShareLinkListResponse> GetShareLinkPagedListAsync(string accessToken, int pageNo = 1, int pageSize = 20)
        {
            if (pageNo <= 1)
            {
                pageNo = 1;
        ...
        /// <param name="accessToken">【必填】令牌</param>
        /// <returns></returns>
        public virtual async Task<ShareLinkListResponse> GetShareLinkAllListAsync(string accessToken)
        {
            return await GetShareLinkPagedListAsync(accessToken, 1, Int32.MaxValue);
        }
        ...
        /// <returns></returns>
        public virtual async Task<DeleteShareLinkResponse> DeleteShareLinkByFileIdAsync(string accessToken, long fileId)
        {
            return await DeleteShareLinkAsync(accessToken, fileId, "file");
        }
        ...
        /// <returns></returns>
        public virtual async Task<DeleteShareLinkResponse> DeleteShareLinkByIntegrateIdAsync(string accessToken, long integrateId)
        {
            return await DeleteShareLinkAsync(accessToken, integrateId, "integrate");
        }
        ...
        /// <returns></returns>
        private async Task<DeleteShareLinkResponse> DeleteShareLinkAsync(string accessToken, long objectId, string objectType)
        {
        ...
        /// <returns></returns>
        public virtual async Task<BatchDeleteShareLinkResponse> BatchDeleteShareLinkAsync(string accessToken, long[] sourceIds)
        {
        ...
        /// <param name="sourceIds">sourceId集合</param>
        /// <returns></returns>
        public virtual async Task<BatchDeleteShareLinkResponse> BatchDeleteShareLinkAsync(string accessToken, List<long> sourceIds)
        {
            return await BatchDeleteShareLinkAsync(accessToken, sourceIds.ToArray());
        }
    }
}