...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial class FileConvertApi : IFileConvertApi
    {
        ...
        /// <returns></returns>
        public virtual async Task<FileTranslateResponse> TranslateDwgToVectorDrawingsAsync(string accessToken, DwgFileTranslateRequest request)
        {
            ...
            return await TranslateFileAsync(accessToken, data);
        }
        ...
        /// <param name="request">DWG文件转化的请求数据对象。根据实际需要设置对象里面的参数，不需要的参数不用赋值</param>
        /// <returns></returns>
        public virtual async Task<FileTranslateResponse> TranslateDwgToPictureAsync(string accessToken, DwgFileTranslateRequest request)
        {
            // 此API详解，参考作者博客：《C#开发BIMFACE系列12 服务端API之文件转换》 https://www.cnblogs.com/SavionZhang/p/11451815.html
        ...
        /// <returns></returns>
        public virtual async Task<FileTranslateResponse> TranslateRvtToRenderStyleAsync(string accessToken, RvtFileTranslateRequest request)
        {
            // 此API详解，参考作者博客：《C#开发BIMFACE系列12 服务端API之文件转换》 https://www.cnblogs.com/SavionZhang/p/11451815.html
        ...
        /// <param name="request">RVT文件转化的请求数据对象。根据实际需要设置对象里面的参数，不需要的参数不用赋值</param>
        /// <returns></returns>
        public virtual async Task<FileTranslateResponse> TranslateRvtToRealStyleAsync(string accessToken, RvtFileTranslateRequest request)
        {
            // 此API详解，参考作者博客：《C#开发BIMFACE系列12 服务端API之文件转换》 https://www.cnblogs.com/SavionZhang/p/11451815.html
        ...
        /// <param name="request">RVT文件转化的请求数据对象。根据实际需要设置对象里面的参数，不需要的参数不用赋值</param>
        /// <returns></returns>
        public virtual async Task<FileTranslateResponse> TranslateRvtTo23LinkStyleAsync(string accessToken, RvtFileTranslateRequest request)
        {
            // 此API详解，参考作者博客：《C#开发BIMFACE系列12 服务端API之文件转换》 https://www.cnblogs.com/SavionZhang/p/11451815.html
        ...
        /// <returns></returns>
        public virtual async Task<FileTranslateResponse> TranslateOther3DModelToWithoutMaterialStyleAsync(string accessToken, Other3DModelFileTranslateRequest request)
        {
            // 此API详解，参考作者博客：《C#开发BIMFACE系列12 服务端API之文件转换》 https://www.cnblogs.com/SavionZhang/p/11451815.html
        ...
        /// <param name="request">其他三维模型文件，包括RVT格式文件转化的请求数据对象。根据实际需要设置对象里面的参数，不需要的参数不用赋值</param>
        /// <returns></returns>
        public virtual async Task<FileTranslateResponse> TranslateOther3DModelToWithMaterialStyleAsync(string accessToken, Other3DModelFileTranslateRequest request)
        {
            // 此API详解，参考作者博客：《C#开发BIMFACE系列12 服务端API之文件转换》 https://www.cnblogs.com/SavionZhang/p/11451815.html
        ...
        /// <returns></returns>
        private async Task<FileTranslateResponse> TranslateFileAsync(string accessToken, string data)
        {
            // 此API详解，参考作者博客：《C#开发BIMFACE系列12 服务端API之文件转换》 https://www.cnblogs.com/SavionZhang/p/11451815.html
            ...
            try
            {
                ...
                HttpResult httpResult = await httpManager.PutAsync(url, data);
        ...
        /// <returns></returns>
        public virtual async Task<FileTranslateResponse> GetFileTranslateStatusAsync(string accessToken, long fileId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<FileTranslateDetailsResponse> GetFileTranslateDetailsAsync(string accessToken, TranslateQueryRequest request)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelElementsSwaggerDisplay> GetSingleModelElementsAsync(string accessToken, string fileId,
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelSingleElementMaterials> GetSingleModelSingleElementMaterialsAsync(string accessToken, long fileId, string elementId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelSingleElementProperty> GetSingleModelSingleElementPropertyAsync(string accessToken, long fileId, string elementId, bool? includeOverrides = null)
        {
        ...
        /// <param name="includeOverrides">【非必填】是否查询修改的属性</param>
        /// <returns></returns>
        public virtual async Task<SingleModelMultipleElementsCommonProperties> GetSingleModelMultipleElementsCommonPropertiesAsync(string accessToken, long fileId, string[] elementIds, bool? includeOverrides = null)
        {
        ...
        /// <param name="includeOverrides">【非必填】是否查询修改的属性</param>
        /// <returns></returns>
        public virtual async Task<SingleModelMultipleElementsCommonProperties> GetSingleModelMultipleElementsCommonPropertiesAsync(string accessToken, long fileId, List<string> elementIds, bool? includeOverrides = null)
        {
            // 此API详解，参考作者博客：《C#开发BIMFACE系列19 服务端API之4：获取多个构件的共同属性》https://www.cnblogs.com/SavionZhang/p/11474013.html

            return await GetSingleModelMultipleElementsCommonPropertiesAsync(accessToken, fileId, elementIds.ToArray(), includeOverrides);
        }
        ...
        /// <param name="includeOverrides">【非必填】是否查询修改的属性</param>
        /// <returns></returns>
        public virtual async Task<SingleModelMultipleElementsProperties> GetSingleModelMultipleElementsPropertiesAsync(string accessToken, long fileId, ElementPropertyFilterRequest request, bool? includeOverrides = null)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelFloors> GetSingleModelFloorsAsync(string accessToken, long fileId, bool? includeArea = null, bool? includeRoom = null)
        {
        ...
        /// <param name="includeRoom">【非必填】是否将楼层中的房间ID、名称一起返回</param>
        /// <returns></returns>
        public virtual async Task<MultipleModelsFloors> GetMultipleModelFloorsAsync(string accessToken, string[] fileIds, bool? includeArea = null, bool? includeRoom = null)
        {
        ...
        /// <param name="fileId">【必填】代表该单模型的文件ID</param>
        /// <returns></returns>
        public virtual async Task<SingleModelLink> GetSingleModelLinkAsync(string accessToken, long fileId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelSingleRoom> GetSingleModelSingleRoomAsync(string accessToken, long fileId, string roomId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelSingleFloorAreas> GetSingleModelSingleFloorAreasAsync(string accessToken, long fileId, string floorId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelSingleArea> GetSingleModelSingleAreaAsync(string accessToken, long fileId, string areaId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelTree> GetSingleModelTreeByDefaultAsync(string accessToken, long fileId, string v = "2.0", FileTreeRequestBody request = null)
        {
        ...
        /// <param name="request">【非必填】其他过滤参数类对象</param>
        /// <returns></returns>
        public virtual async Task<SingleModelTreeByCustomized> GetSingleModelTreeByCustomizedAsync(string accessToken, long fileId, string v = "2.0", FileTreeRequestBody request = null)
        {
            //return GetSingleModelTree(accessToken, fileId, TreeType.Default, v, request);
            /* 单模型构件分类树,
              （1）treeType 接受两个值：default 和 customized，默认为 default。
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelTree> GetSingleModelTreeAsync(string accessToken, long fileId, TreeType treeType = TreeType.Default, string v = "2.0", FileTreeRequestBody request = null)
        {
            /* 单模型构件分类树,
              （1）treeType 接受两个值：default 和 customized，默认为 default。
              （2）v 参数用来区别 treeType 为 default 时返回树的格式, customized 总是返回格式2.0的构件树。 
        ...
        /// <param name="fileId">【必填】代表该单模型的文件ID</param>
        /// <returns></returns>
        public virtual async Task<SingleModelViews> GetSingleModelViewsAsync(string accessToken, long fileId)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SingleModelDrawingSheets> GetSingleModelDrawingSheetsAsync(string accessToken, long fileId, string elementId = null)
        {
        ...
        /// <returns></returns>
        public virtual async Task<SplitDrawingResponse> SplitDrawingAsync(string accessToken, long fileId, string callbak = "")
        {
            ...
            try
            {
                ...
                HttpManager httpManager = new HttpManager(headers);
                HttpResult httpResult = await httpManager.PutAsync(url);
                if (httpResult.Status == HttpResult.STATUS_SUCCESS)
                {
        ...
        /// <param name="fileId">【必填】代表该单图纸的文件ID</param>
        /// <returns></returns>
        public virtual async Task<SplitDrawingResponse> GetSplitDrawingStatusAsync(string accessToken, long fileId)
        {
        ...
        /// <param name="fileId"></param>
        /// <returns></returns>
        public virtual async Task<SplitDrawingResultResponse> GetSplitDrawingResultAsync(string accessToken, long fileId)
        {
