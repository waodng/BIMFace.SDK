...
namespace BIMFace.SDK.CSharp.API
{
    ...
    public partial class GltfDatabagApi : IGltfDatabagApi
    {
        ...
        /// <returns></returns>
        public virtual async Task<DatabagDerivativeCreateResponse> CreateDatabagByFileIdAsync(string accessToken, long fileId, string callback = null)
        {
            return await CreateDatabagAsync(accessToken, fileId, ModelType.fileId, callback);
        }
        ...
        /// <param name="callback">回调地址</param>
        /// <returns></returns>
        public virtual async Task<DatabagDerivativeCreateResponse> CreateDatabagByIntegrateIdAsync(string accessToken, long integrateId, string callback = null)
        {
            return await CreateDatabagAsync(accessToken, integrateId, ModelType.integrateId, callback);
        }

        private async Task<DatabagDerivativeCreateResponse> CreateDatabagAsync(string accessToken, long objectId, ModelType modelType, string callback = null)
        {
        ...
        /// <param name="fileId">【必填】文件Id</param>
        /// <returns></returns>
        public virtual async Task<DatabagDerivativeQueryResponse> QueryDatabagByFileIdAsync(string accessToken, long fileId)
        {
            return await QueryDatabagAsync(accessToken, fileId, ModelType.fileId);
        }
        ...
        /// <param name="integrateId">【必填】模型集成Id</param>
        /// <returns></returns>
        public virtual async Task<DatabagDerivativeQueryResponse> QueryDatabagByIntegrateIdAsync(string accessToken, long integrateId)
        {
            return await QueryDatabagAsync(accessToken, integrateId, ModelType.integrateId);
        }

        private async Task<DatabagDerivativeQueryResponse> QueryDatabagAsync(string accessToken, long objectId, ModelType modelType)
        {
            /* 通过传入相应的ID创建对应Gltf数据包:
        ...
        /// <returns></returns>
        public virtual async Task<GetUrlSwaggerDisplay> GetDatabagDownloadUrlByFileIdAsync(string accessToken, long fileId, string databagVersion)
        {
            return await GetDatabagDownloadUrlAsync(accessToken, fileId, ModelType.fileId, databagVersion);
        }
        ...
        /// <param name="databagVersion">数据包版本；对于offline、vr数据包，如果只有一个，则下载唯一的数据包，如果多个，则必须指定数据包版本</param>
        /// <returns></returns>
        public virtual async Task<GetUrlSwaggerDisplay> GetDatabagDownloadUrlByIntegrateIdAsync(string accessToken, long integrateId, string databagVersion)
        {
            return await GetDatabagDownloadUrlAsync(accessToken, integrateId, ModelType.integrateId, databagVersion);
        }

        private async Task<GetUrlSwaggerDisplay> GetDatabagDownloadUrlAsync(string accessToken, long objectId, ModelType modelType, string databagVersion)
        {
