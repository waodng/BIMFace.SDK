        ...
        <div style="margin: 10px; width: 860px;">
            ...
            <asp:Panel ID="Panel1ForDWG" runat="server" BorderStyle="Dotted" GroupingText="模型比对">
                ...
                <div style="margin: 5px;">
                    ...
                    &nbsp;<asp:Button ID="btnGetModelCompareDiffAll" runat="server" Text="获取模型/图纸对比结果(所有)" Width="260px" OnClick="btnGetModelCompareDiffAll_Click" />
                    &nbsp;<asp:Button ID="btnGetModelCompareDiff" runat="server" Text="分页获取模型/图纸对比结果" Width="260px" OnClick="btnGetModelCompareDiff_Click" />
                    <br />
                    &nbsp;<asp:Button ID="btnGetDrawingCompareDatabage" runat="server" Text="获取图纸对比数据包信息" Width="260px" OnClick="btnGetDrawingCompareDatabage_Click" />
                    <br />
                      
                    <asp:Label ID="Label4" runat="server" Text="DatabagId：">
                    </asp:Label><asp:TextBox ID="txtDatabagId" runat="server" Width="246px"></asp:TextBox>
